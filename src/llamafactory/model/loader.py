...
from .model_utils.dr_model import QwenWithDrInAgent, Qwen2ForCausalLMPNLDenseRetrieval,Qwen2ForCausalLMRelevanceDenseRetrieval, TradeQwenDR
    ...
    if model is None and not lazy_load:
        ...
        if model_args.mixture_of_depths == "load":
            ...
            if type(config) in AutoModelForVision2Seq._model_mapping.keys():  # image-text
                ...
                elif model_args.model_use_trade_dr == True:
                    load_class = TradeQwenDR
                else:
